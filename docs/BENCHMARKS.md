...
2. State 2 (Active HTTP Status Polling):
   ...
   * This results in a transient $\approx 6\text{ KB}$ dip in free heap. **This is immediately deallocated** when `handleClient` terminates and closes the socket, causing zero permanent fragmentation.
